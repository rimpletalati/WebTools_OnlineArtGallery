...
public class PDFView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> map, Document document,
		...
		Chunk chunk = new Chunk("Order Summary!");
		...
		Cell cell12 = new Cell("Painting Name: ");
		cell12.setBackgroundColor(Color.white);
		

		Cell cell13 = new Cell("   Price: ");
		...
		for (OrderItem oi : order.getOrderItem()) {
			Cell cell15 = new Cell("   " + oi.getPainting().getName());
			table3.addCell(cell15);

			/*Cell cell16 = new Cell("   " + String.valueOf(oi.getQuantity()));*/

			/*table3.addCell(cell16);*/
			Cell cell16 = new Cell("   " + String.valueOf(oi.getTotalCost()));
			table3.addCell(cell16);
		}
